...
let usuarios = [
    {id:1, 
    nome:"Paulo Silva", 
    email: "slçdkgms@gmail.com", 
    telefone: " (11) 99999-9999"},

    {id:2, 
    nome:"Paulo Arruda", 
    email: "uierujk@gmail.com", 
    telefone: " (11) 99999-7894"},
]
...
app.post("/api/usuarios", (req, res) =>{
    ...
    res.status(201).json({
        "msg": "Usuario criado com sucesso", "Usuario": novoUsuario
    })
...
app.delete("/api/usuarios/:id", (req, res) =>{
    const {id} = req.params;
    const usuario = usuarios.find(u => id === parseInt(id));
    if(usuario){
        res.status(404).json({"msg": "Nenhum usuario encontrado."})
        return;
    }
    usuarios = usuarios.filter(u => u.id !== parseInt)
})
